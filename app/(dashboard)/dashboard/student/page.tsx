...
export default function StudentDashboardPage() {
  const stats = [
    { label: "Upcoming Exams", value: "0", icon: Clock, color: "text-secondary", bg: "bg-secondary/10" },
    { label: "Completed", value: "0", icon: CheckCircle, color: "text-emerald-400", bg: "bg-emerald-500/10" },
    { label: "Avg. Score", value: "—", icon: ClipboardList, color: "text-amber-400", bg: "bg-amber-500/10" },
  ];

  return (
    <div className="space-y-8">
      <div>
        <h1 className="font-[Rasa] text-3xl font-bold tracking-tight">Student Dashboard</h1>
        <p className="font-[Nunito] mt-1 text-sm text-muted-foreground">
          View your exams, take tests, and check results.
        </p>
      </div>
